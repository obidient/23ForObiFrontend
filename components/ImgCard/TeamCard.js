  ...
  return (
    <div className="flex flex-col items-center justify-center my-7">
      <div className="relative p-2">
        <Image src={src} width="130px" height="130px" alt="" />
        <div className={styles.logo}>
          <Link href={linkedIn ? linkedIn : 'https://linkedin.com'}>
            <Image src={LinkedInLogo} width="32px" height="32px" />
          </Link>
        </div>
      </div>
      <h2 className="font-bold text-3xl my-2">{name ? name : 'Member Name'}</h2>
      <h3 className="font-normal text-2xl mb-5">{position ? position : 'Position'}</h3>
